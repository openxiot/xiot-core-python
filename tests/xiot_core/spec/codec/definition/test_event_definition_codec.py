...
class TestEventDefinitionCodec(unittest.TestCase):
    def test_codec(self) -> None:
        """Test EventDefinitionCodec"""
        self._decode("/definition/events/xiot")
    ...
    def _decode_file(self, file_path: pathlib.Path) -> None:
        ...
        # 编解码测试
        definition = EventDefinitionCodec.decode(original_json)
        encoded_json = EventDefinitionCodec.encode(definition)
