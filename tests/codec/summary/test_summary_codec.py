...
from xiot_spec.codec.summary.summary_codec import SummaryCodec

class TestSummaryCodec(unittest.TestCase):
    def test_codec(self) -> None:
        """Test SummaryCodec"""
        self._decode("/summary")
    ...
    def _decode_file(self, file_path: pathlib.Path) -> None:
        ...
        # 编解码测试
        summaries = SummaryCodec.decode_list(original_json["summaries"])
        encoded_json = {"summaries": SummaryCodec.encode_collection(summaries)}
