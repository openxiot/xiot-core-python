...
from xiot_spec.codec.shadow.shadow_codec import ShadowCodec
...
class TestShadowCodec(unittest.TestCase):
    ...
    def _decode_file(self, file_path: pathlib.Path) -> None:
        ...
        # 编解码测试
        shadows = ShadowCodec.decode_array(original_json["shadows"])
        encoded_json = {"shadows": ShadowCodec.encode_collection(shadows)}
