...
class Vint32(DataValue[int]):
    ...
    def validate_with_step(self, min_value: DataValue, max_value: DataValue, step: DataValue) -> bool:
        ...
        print(f"Vint32.validate failed: {self._value} min: {min_v} max: {max_v} step: {step}")
        return False
