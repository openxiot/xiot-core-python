...
from src.spec.typedef.operation.abstract_operation import AbstractOperation
from src.spec.typedef.operation.argument_operation import ArgumentOperation
